...
print("choose your network environment\n\
      1. CERNET edu\n\
      2. CTCNET dian xin\n\
      3. CNCNET lian tong\n\
      4. DXT    dian xin tong\n\
...
#i = raw_input()  
i = 1 #because i'm edu network environment
if i == 1:  
...
print("host:" + proxy_host + "address:")  
print(local_ip)
print("your can set for local machine in\n127.0.0.1")
print("port:")
print(local_port)
